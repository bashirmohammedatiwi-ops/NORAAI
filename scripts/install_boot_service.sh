...
echo "  aiops-health.timer  — watchdog every 2 min + autoheal container"
echo ""
echo "Also recommended on 4GB VPS:"
echo "  sudo ./scripts/setup_swap.sh"
echo ""
echo "Watchdog log: ${PROJECT_DIR}/logs/watchdog.log"
echo ""
