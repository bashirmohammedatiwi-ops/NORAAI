...
DEFAULT_MODELS = [
    "Accident Detection", "Pothole Detection", "Road Crack Detection",
    "Barrier Detection", "Road Closed Detection", "Speed Sign Detection",
    "Vehicle Detection", "Traffic Density Detection",
]
